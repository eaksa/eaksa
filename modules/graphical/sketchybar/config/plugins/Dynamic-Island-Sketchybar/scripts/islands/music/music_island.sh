...
ARTWORK_LOCATION="$CONFIG_DIR/plugins/Dynamic-Island-Sketchybar/scripts/islands/music/artwork.jpg"
...
if [[ $P_DYNAMIC_ISLAND_MUSIC_SOURCE == "Music" ]]; then
	osascript "$CONFIG_DIR/plugins/Dynamic-Island-Sketchybar/scripts/islands/music/get_artwork.scpt"
...
source "$CONFIG_DIR/plugins/Dynamic-Island-Sketchybar/scripts/islands/music/reset.sh"
